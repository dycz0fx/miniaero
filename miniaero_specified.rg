...
local launcher_specified = require("launcher_specified")
if os.getenv('SAVE_MAPPER_ONLY') == '1' then
  launcher_specified.compile_mapper(true, "miniaero")
  os.exit(0)
end
...
local pr = terralib.includec("stdio.h")
...
launcher_specified.launch(toplevel, "miniaero")
