...
#include "guided_sample_mapper.h"
...
class MiniAeroMapper : public GuidedSampleMapper
{
public:
...
MiniAeroMapper::MiniAeroMapper(MapperRuntime *rt, Machine machine, Processor local,
                               const char *mapper_name)
  : GuidedSampleMapper(rt, machine, local, mapper_name)
{
  //add_task_to_care(...)
...
//  add_task_to_care("Vec3Average");
  ...
  name_application("miniaero_guided_sample");
}
